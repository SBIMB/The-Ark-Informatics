 ...
 *
 */
public class ShipmentTabProviderImpl extends Panel implements IMainTabProvider{
	
	private static final long	serialVersionUID	= 1L;
	private List<ITab>			moduleTabsList;

	public ShipmentTabProviderImpl(String panelId) {
		super(panelId);
	...
	public List<ITab> buildTabs() {
		// Main tab
		ITab iTab = createTab(au.org.theark.core.Constants.ARK_MODULE_SHIPMENT);
		...
		return new ArkMainTab(new Model<String>(tabName)) {
			...
			public boolean isAccessible() {
				...
				if (sessionStudyId == null) {
					this.getPanel(au.org.theark.core.Constants.ARK_MODULE_SHIPMENT).error(au.org.theark.core.Constants.NO_STUDY_IN_CONTEXT_MESSAGE);
					return false;
				}
				else
					return true;
			...
			public boolean isVisible() {
				return ArkPermissionHelper.isModuleAccessPermitted(au.org.theark.core.Constants.ARK_MODULE_SHIPMENT);
			}
		};
	}
