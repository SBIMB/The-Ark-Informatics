...
public class AddressType implements java.io.Serializable {
	...
	@Id
	@SequenceGenerator(name = "addresstype_generator", sequenceName = "ADDRESSTYPE_SEQUENCE")
	@GeneratedValue(strategy = GenerationType.AUTO, generator = "addresstype_generator")
	public Long getId() {
		return this.id;
	}
