package za.ac.theark.shipment.web.component.shipmentdetails;
...
import au.org.theark.genomics.web.component.analysis.DetailPanel;
import au.org.theark.genomics.web.component.analysis.SearchPanel;
import au.org.theark.genomics.web.component.analysis.SearchResultListPanel;
import za.ac.theark.shipment.web.component.shipmentdetails.form.ContainerForm;

public class ShipmentContainerPanel extends AbstractContainerPanel {
	...
	public ShipmentContainerPanel(String id) {
		super(id);
